...
public class UploadManager {
    ...
    public void formUpload(final File file, final Map<String, Object> params, String apiKey, SignatureListener signatureListener, final UpCompleteListener completeListener, final UpProgressListener progressListener) {
        this.upload(UploadType.FORM, file, params, apiKey, signatureListener, completeListener, progressListener);
    }

    public void blockUpload(final File file, final Map<String, Object> params, String apiKey, SignatureListener signatureListener, final UpCompleteListener completeListener, final UpProgressListener progressListener) {
        this.upload(UploadType.BLOCK, file, params, apiKey, signatureListener, completeListener, progressListener);
    }

    private void upload(UploadType type, final File file, final Map<String, Object> params, String apiKey, SignatureListener signatureListener, final UpCompleteListener completeListener, final UpProgressListener progressListener) {
        
        if (completeListener == null) {
            throw new RuntimeException("completeListener 不可为null");
        } else if (file == null) {
            completeListener.onComplete(false, "文件不可以为空", -1);
            return;
        } else if (params == null) {
            completeListener.onComplete(false, "参数不可为空", -1);
            return;
        } else if (apiKey == null && signatureListener == null) {
            completeListener.onComplete(false, "APIkey和signatureListener不可同时为null", -1);
            return;
        }
    ...
    public void upload(final File file, final Map<String, Object> params, String apiKey, SignatureListener signatureListener, final UpCompleteListener completeListener, final UpProgressListener progressListener) {
