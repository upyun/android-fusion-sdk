...
public class QiniuResumeTest extends TestCase {
    private static final String TAG = "QiniuResumeTest";
    ...
    public void testQiniuResume() throws Exception {
        ...
        QiniuResume qiniuResume = new QiniuResume(temp, TOKEN, savePath, null, completeListener, progressListener);
        new Thread(qiniuResume).start();
        latch.await();
    }
}